...
- Design Direction Showcase: [ux-design-directions.html](./refs/ux/ux-design-directions.html)
...
- Interactive artifacts stored alongside this doc: `_bmad-output/planning-artifacts/refs/ux/ux-color-themes.html`, `_bmad-output/planning-artifacts/refs/ux/ux-design-directions.html`, `_bmad-output/planning-artifacts/refs/ux/ux-button-options.html`, and `_bmad-output/planning-artifacts/refs/ux/ux-feedback-options.html` for stakeholders to review visually.
- Color analysis pipeline confirmed as an in-house build so user imagery never leaves CoutureCast’s boundary and styling slots stay privacy-safe. **Corrected 2026-08-26:** this line originally said “on-device palette detection”, which was written before ADR-014 settled the question and is false about what shipped. Processing is SERVER-SIDE, in the NestJS worker, with Sharp; the reason on-device was rejected is recorded in ADR-014 (model size, inconsistent device performance, and the inability to update classification without an app release). The privacy claim in this line survives the correction and is in fact stronger than it was: story 5.4’s Decision 8 purges the selfie object on every terminal branch of the analysis, so a face image is never at rest after the analysis ends, and only derived metadata — undertone, depth, confidence — is stored or returned. A reader who took “on-device” literally would have been wrong about where face images are processed, which is why the words are changed here rather than annotated elsewhere.
...
- Product Brief: `_bmad-output/project-knowledge/couturecast_brief.md`
- Brainstorming: `_bmad-output/planning-artifacts/refs/brainstorming.md (if created)`

### Core Interactive Deliverables

This UX Design Specification was created through visual collaboration:

- **Color Theme Visualizer**: \_bmad-output/planning-artifacts/refs/ux/ux-color-themes.html
  - Interactive HTML showing all color theme options explored
  - Live UI component examples in each theme
  - Side-by-side comparison and semantic color usage

- **Design Direction Mockups**: \_bmad-output/planning-artifacts/refs/ux/ux-design-directions.html
