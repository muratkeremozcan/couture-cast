...
- [Architecture: ADR-002 Media Pipeline](../planning-artifacts/architecture.md#adr-002)
- [Architecture: ADR-004 Auth & Roles](../planning-artifacts/architecture.md#adr-004)
- [Architecture: Deployment Architecture](../planning-artifacts/architecture.md#deployment-architecture)
- [Test Design: Deployment & Environment Strategy](../test-artifacts/test-design-system.md#deployment--environment-strategy)
- [Test Design: Secrets & Configuration Management](../test-artifacts/test-design-system.md#secrets--configuration-management)
- [Epics: Epic 0 Story CC-0.3](../planning-artifacts/epics.md#story-cc-03-set-up-supabase-projects-dev-staging-prod)
...
- MODIFIED: \_bmad-output/implementation-artifacts/0-3-set-up-supabase-projects-dev-staging-prod.md
