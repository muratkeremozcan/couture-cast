...
4. Implement seed scripts (`prisma/seeds/`) with coverage per \_bmad-output/test-artifacts/test-design-system.md: 5 teens, 3 guardians, 50 wardrobe items, 20 rituals, 10 weather snapshots, 8 feature flags.
...
- [Architecture: ADR-001 Data Persistence](../planning-artifacts/architecture.md#adr-001)
- [Architecture: ADR-005 Multi-Tenant Data Isolation](../planning-artifacts/architecture.md#adr-005)
- [Test Design: Test Data Management Strategy](../test-artifacts/test-design-system.md#test-data-management-strategy)
- [Test Design: Seed Data Coverage](../test-artifacts/test-design-system.md#seed-data-synchronization)
- [Epics: Epic 0 Story CC-0.2](../planning-artifacts/epics.md#story-cc-02-configure-prisma-schema-migrations-and-seed-data)
...
- No story context XML available; used \_bmad-output/planning-artifacts/architecture.md, \_bmad-output/planning-artifacts/epics.md, \_bmad-output/planning-artifacts/ux-design-specification.md
