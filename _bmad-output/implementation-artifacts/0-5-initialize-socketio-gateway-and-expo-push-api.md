...
- [x] Task 4: Create shared payload schema (AC: #4)
  ...
  - [x] Document event schema in `_bmad-output/project-knowledge/api-events.md`
...
export interface AlertWeatherEvent
  extends BaseEvent<{
...
- [Architecture: ADR-007 Real-time + Notifications](../planning-artifacts/architecture.md#architecture-decision-records-adrs)
- [Architecture: Technology Stack](../planning-artifacts/architecture.md#technology-stack-details)
- [Architecture: Integration Points](../planning-artifacts/architecture.md#integration-points)
- [Epics: Epic 0 Story CC-0.5](../planning-artifacts/epics.md#epic-0--platform-foundation--infrastructure-sprint-0)
...
- \_bmad-output/project-knowledge/api-events.md
- package-lock.json
...
| 2025-12-06 | Amelia (Dev Agent) | Task 4: shared socket event types/schemas + \_bmad-output/project-knowledge/api-events.md                        |
