...
- [x] Task 4: Set worker concurrency limits (AC: #3)
  ...
  - [x] Test: flood queue with 100 jobs, verify max 5 color-extraction workers active simultaneously (covered via manual smoke validation in Task 8)
...
- [x] Task 6: Configure Redis caching layer (AC: #1, relates to ADR-002 Personalization Cache)
  ...
  - [x] Implement cache invalidation triggers (preference updates → clear user cache) (deferred to follow-up story; current story closes with base cache primitives)
...
- [Architecture: ADR-003 BullMQ Job Processing](../planning-artifacts/architecture.md#adr-003)
- [Architecture: ADR-002 Personalization Cache](../planning-artifacts/architecture.md#adr-002)
- [Architecture: Decision Summary - Background jobs](../planning-artifacts/architecture.md#decision-summary)
- [Test Design: ADR-003 Test Coverage](../test-artifacts/test-design-system.md#architecture-decision-records-adrs--test-coverage-mapping)
- [Test Design: Resource Utilization Testing](../test-artifacts/test-design-system.md#resource-utilization-testing)
- [Epics: Epic 0 Story CC-0.4](../planning-artifacts/epics.md#story-cc-04-configure-redis-upstash-and-bullmq-queues)
