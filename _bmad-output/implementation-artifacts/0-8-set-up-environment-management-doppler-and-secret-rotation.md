...
- [ ] Task 2: Define secret schema and populate secrets (AC: #1)
  - [ ] Create secret list per environment in `_bmad-output/project-knowledge/secrets-management.md`:
...
- [ ] Task 4: Implement health check endpoint (AC: #2)
  ...
  - [ ] Add health check to deployment workflows:
    ...
    ```
  - [ ] Document health check in `_bmad-output/project-knowledge/api-reference.md`
...
- [ ] Task 5: Set up gitleaks for secret scanning (AC: #3)
  ...
  - [ ] Create `.gitleaks.toml` configuration in repo root:
    ...
    paths = [
      '''      '''_bmad-output/project-knowledge/examples/'''
    ]
    ```
  ...
  - [ ] Document gitleaks setup in `_bmad-output/project-knowledge/secrets-management.md`
...
- [ ] Task 7: Document secret rotation schedule (AC: #4)
  - [ ] Create `_bmad-output/project-knowledge/secrets-management.md` with rotation policy:
...
- [ ] Task 8: Test secret rotation in staging (AC: #4)
  ...
  - [ ] Document test results in `_bmad-output/project-knowledge/secrets-management.md`
...
- [ ] Task 9: Enforce least-privilege service keys (AC: #5)
  ...
  - [ ] Document service account strategy in `_bmad-output/project-knowledge/secrets-management.md`
...
- [ ] Task 10: Create Doppler sync automation (AC: #1)
  ...
  - [ ] Document webhook setup in `_bmad-output/project-knowledge/secrets-management.md`
...
- [ ] Task 11: Implement secret access audit logging (AC: #4)
  ...
  - [ ] Document audit logging in `_bmad-output/project-knowledge/secrets-management.md`

- [ ] Task 12: Document secrets management for team
  - [ ] Create `_bmad-output/project-knowledge/secrets-management.md` with sections:
...
export class HealthController {
  ...
  private async validateSecrets() {
    const requiredSecrets = ['DATABASE_URL', 'REDIS_URL', 'SUPABASE_URL', 'JWT_SECRET']
