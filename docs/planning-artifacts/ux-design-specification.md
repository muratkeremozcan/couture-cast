...
- Interactive artifacts stored alongside this doc: `docs/planning-artifacts/refs/ux/ux-color-themes.html`, `docs/planning-artifacts/refs/ux/ux-design-directions.html`, `docs/planning-artifacts/refs/ux/ux-button-options.html`, and `docs/planning-artifacts/refs/ux/ux-feedback-options.html` for stakeholders to review visually.
...
- Product Requirements: `docs/planning-artifacts/prd.md`
- Product Brief: `docs/couturecast_brief.md`
- Brainstorming: `docs/planning-artifacts/refs/brainstorming.md (if created)`

### Core Interactive Deliverables

This UX Design Specification was created through visual collaboration:

- **Color Theme Visualizer**: docs/planning-artifacts/refs/ux/ux-color-themes.html

  - Interactive HTML showing all color theme options explored
  - Live UI component examples in each theme
  - Side-by-side comparison and semantic color usage

- **Design Direction Mockups**: docs/planning-artifacts/refs/ux/ux-design-directions.html
