...
4. Implement seed scripts (`prisma/seeds/`) with coverage per docs/test-artifacts/test-design-system.md: 5 teens, 3 guardians, 50 wardrobe items, 20 rituals, 10 weather snapshots, 8 feature flags.
...
- No story context XML available; used docs/planning-artifacts/architecture.md, docs/planning-artifacts/epics.md, docs/planning-artifacts/ux-design-specification.md
