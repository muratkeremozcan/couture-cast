...
2. Document access/runbooks for each environment in `docs/test-artifacts/test-environments.md`.
...
- [ ] Task 5: Configure cross-surface device matrix (AC: #1)
  ...
  - [ ] Document device matrix in `docs/test-artifacts/test-environments.md`
...
- [ ] Task 6: Create localization snapshot suite (AC: #1)
  ...
  - [ ] Implement snapshot tests:
    ...
    ```
  - [ ] Document localization testing in `docs/test-artifacts/test-environments.md`

- [ ] Task 7: Document environment access (AC: #2)
  - [ ] Create `docs/test-artifacts/test-environments.md` with sections:
...
- [ ] Task 10: Create environment teardown scripts (AC: #5)
  ...
  - [ ] Document teardown procedures in `docs/test-artifacts/test-environments.md`
...
- [ ] Task 12: Create environment health dashboard (AC: #5)
  ...
  - [ ] Document dashboard access in `docs/test-artifacts/test-environments.md`
